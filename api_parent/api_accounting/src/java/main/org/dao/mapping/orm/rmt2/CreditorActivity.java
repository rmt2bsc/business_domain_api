...
public class CreditorActivity extends OrmBean {
    ...
    // CreditorActivityView

    /**
     * The property name constant equivalent to property, CreditorActvId, of
     ...
     * creditor_activity.creditor_actv_id
     */
    private int creditorActvId;
    /**
     * The javabean property equivalent of database column
     * creditor_activity.creditor_id
     */
    private int creditorId;
    /**
     * The javabean property equivalent of database column
     * creditor_activity.xact_id
     */
    private int xactId;
    /**
     * The javabean property equivalent of database column
     * creditor_activity.amount
     */
    private double amount;
    /**
     * The javabean property equivalent of database column
     * creditor_activity.date_created
     */
    private java.util.Date dateCreated;
    /**
     * The javabean property equivalent of database column
     * creditor_activity.date_updated
     */
    private java.util.Date dateUpdated;
    /**
     * The javabean property equivalent of database column
     * creditor_activity.user_id
     */
    private String userId;
    /**
     * The javabean property equivalent of database column
     * creditor_activity.ip_created
     */
    private String ipCreated;
    /**
     * The javabean property equivalent of database column
     * creditor_activity.ip_updated
     */
