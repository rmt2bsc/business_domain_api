...
public class PurchaseOrderStatusHist extends OrmBean {
    ...
    // PurchaseOrderStatusHistView

    /**
     * The property name constant equivalent to property, PoStatusHistId, of
     ...
     * purchase_order_status_hist.po_status_hist_id
     */
    private int poStatusHistId;
    /**
     * The javabean property equivalent of database column
     * purchase_order_status_hist.po_status_id
     */
    private int poStatusId;
    /**
     * The javabean property equivalent of database column
     * purchase_order_status_hist.po_id
     */
    private int poId;
    /**
     * The javabean property equivalent of database column
     * purchase_order_status_hist.effective_date
     */
    private java.util.Date effectiveDate;
    /**
     * The javabean property equivalent of database column
     * purchase_order_status_hist.end_date
     */
    private java.util.Date endDate;
    /**
     * The javabean property equivalent of database column
     * purchase_order_status_hist.user_id
     */
