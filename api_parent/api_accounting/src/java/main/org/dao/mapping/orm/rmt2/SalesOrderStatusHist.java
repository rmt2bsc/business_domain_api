...
public class SalesOrderStatusHist extends OrmBean {
    ...
    // SalesOrderStatusHistView

    /**
     * The property name constant equivalent to property, SoStatusHistId, of
    ...
    /**
     * The property name constant equivalent to property, SoStatusId, of
     * respective DataSource view.
     */
     ...
     * sales_order_status_hist.so_status_hist_id
     */
    private int soStatusHistId;
    /**
     * The javabean property equivalent of database column
     * sales_order_status_hist.so_id
     */
    private int soId;
    /**
     * The javabean property equivalent of database column
     * sales_order_status_hist.so_status_id
     */
    private int soStatusId;
    /**
     * The javabean property equivalent of database column
     * sales_order_status_hist.effective_date
     */
    private java.util.Date effectiveDate;
    /**
     * The javabean property equivalent of database column
     * sales_order_status_hist.end_date
     */
    private java.util.Date endDate;
    /**
     * The javabean property equivalent of database column
     * sales_order_status_hist.reason
     */
    private String reason;
    /**
     * The javabean property equivalent of database column
     * sales_order_status_hist.date_created
     */
    private java.util.Date dateCreated;
    /**
     * The javabean property equivalent of database column
     * sales_order_status_hist.user_id
     */
    private String userId;
    /**
     * The javabean property equivalent of database column
     * sales_order_status_hist.ip_created
     */
    private String ipCreated;
    /**
     * The javabean property equivalent of database column
     * sales_order_status_hist.ip_updated
     */
