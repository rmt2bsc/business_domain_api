...
public class VwXactGlPostingList extends OrmBean {
    ...
    /**
     * The property name constant equivalent to property, GlAccountId, of
     * respective DataSource view.
     */
    public static final String PROP_GLACCOUNTID = "GlAccountId";
    /**
     * The property name constant equivalent to property, GlAcctName, of
     * respective DataSource view.
     */
    ...
    /**
     * The property name constant equivalent to property, PostDate, of
     * respective DataSource view.
     */
     ...
     * vw_xact_gl_posting_list.id
     */
    private int id;
    /**
     * The javabean property equivalent of database column
     * vw_xact_gl_posting_list.gl_account_id
     */
    private int glAccountId;
    /**
     * The javabean property equivalent of database column
     * vw_xact_gl_posting_list.gl_acct_name
     */
    private String glAcctName;
    /**
     * The javabean property equivalent of database column
     * vw_xact_gl_posting_list.xact_amount
     */
    private double xactAmount;
    /**
     * The javabean property equivalent of database column
     * vw_xact_gl_posting_list.xact_date
     */
    private java.util.Date xactDate;
    /**
     * The javabean property equivalent of database column
     * vw_xact_gl_posting_list.post_date
     */
    private java.util.Date postDate;
    /**
     * The javabean property equivalent of database column
     * vw_xact_gl_posting_list.xact_type_id
     */
    private int xactTypeId;
    /**
     * The javabean property equivalent of database column
     * vw_xact_gl_posting_list.xact_type_name
     */
    private String xactTypeName;
    /**
     * The javabean property equivalent of database column
     * vw_xact_gl_posting_list.xact_category_id
     */
    private int xactCategoryId;
    /**
     * The javabean property equivalent of database column
     * vw_xact_gl_posting_list.xact_category_description
     */
    private String xactCategoryDescription;
    /**
     * The javabean property equivalent of database column
     * vw_xact_gl_posting_list.to_multiplier
     */
    private int toMultiplier;
    /**
     * The javabean property equivalent of database column
     * vw_xact_gl_posting_list.from_multiplier
     */
    private int fromMultiplier;
    /**
     * The javabean property equivalent of database column
     * vw_xact_gl_posting_list.to_acct_type_id
     */
    private int toAcctTypeId;
    /**
     * The javabean property equivalent of database column
     * vw_xact_gl_posting_list.to_acct_catg_id
     */
    private int toAcctCatgId;
    /**
     * The javabean property equivalent of database column
     * vw_xact_gl_posting_list.from_acct_type_id
     */
    private int fromAcctTypeId;
    /**
     * The javabean property equivalent of database column
     * vw_xact_gl_posting_list.from_acct_catg_id
     */
    private int fromAcctCatgId;
    /**
     * The javabean property equivalent of database column
     * vw_xact_gl_posting_list.has_subsidiary
     */
    private int hasSubsidiary;
    /**
     * The javabean property equivalent of database column
     * vw_xact_gl_posting_list.reason
     */
