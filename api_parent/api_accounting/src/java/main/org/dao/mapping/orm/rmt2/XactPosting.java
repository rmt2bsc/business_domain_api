...
public class XactPosting extends OrmBean {
    ...
    /**
     * The property name constant equivalent to property, XactPostId, of
    ...
    /**
     * The property name constant equivalent to property, AcctSubsidiaryId, of
     * respective DataSource view.
     */
    public static final String PROP_ACCTSUBSIDIARYID = "AcctSubsidiaryId";
    /**
     * The property name constant equivalent to property, AcctPeriodId, of
     * respective DataSource view.
     */
    public static final String PROP_ACCTPERIODID = "AcctPeriodId";
    /**
     * The property name constant equivalent to property, Period, of respective
     * DataSource view.
     */
    public static final String PROP_PERIOD = "Period";
    /**
     * The property name constant equivalent to property, PostAmount, of
     * respective DataSource view.
     */
    ...
    /**
     * The javabean property equivalent of database column
     * xact_posting.acct_subsidiary_id
     */
    private String acctSubsidiaryId;
    /**
     * The javabean property equivalent of database column
     * xact_posting.acct_period_id
     */
    ...
    /**
     * The javabean property equivalent of database column
     * xact_posting.post_amount
     */
    private double postAmount;
    /**
     * The javabean property equivalent of database column
     * xact_posting.post_date
     */
    private java.util.Date postDate;
    /**
     * The javabean property equivalent of database column
     * xact_posting.date_created
     */
    private java.util.Date dateCreated;
    /**
     * The javabean property equivalent of database column
     * xact_posting.date_updated
     */
