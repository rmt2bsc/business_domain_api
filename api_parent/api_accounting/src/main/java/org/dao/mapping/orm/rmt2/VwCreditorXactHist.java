...
public class VwCreditorXactHist extends OrmBean {
    ...
    /**
     * The property name constant equivalent to property, CreditorActivityId, of
     * respective DataSource view.
     */
    public static final String PROP_CREDITORACTIVITYID = "CreditorActivityId";
    /**
     * The property name constant equivalent to property,
     * CreditorActivityAmount, of respective DataSource view.
     */
     ...
     * vw_creditor_xact_hist.xact_id
     */
    private int xactId;
    /**
     * The javabean property equivalent of database column
     * vw_creditor_xact_hist.creditor_id
     */
    private int creditorId;
    /**
     * The javabean property equivalent of database column
     * vw_creditor_xact_hist.account_number
     */
    private String accountNumber;
    /**
     * The javabean property equivalent of database column
     * vw_creditor_xact_hist.creditor_type_id
     */
    private int creditorTypeId;
    /**
     * The javabean property equivalent of database column
     * vw_creditor_xact_hist.active
     */
    private int active;
    /**
     * The javabean property equivalent of database column
     * vw_creditor_xact_hist.apr
     */
    private double apr;
    /**
     * The javabean property equivalent of database column
     * vw_creditor_xact_hist.credit_limit
     */
    private double creditLimit;
    /**
     * The javabean property equivalent of database column
     * vw_creditor_xact_hist.creditor_type_description
     */
    private String creditorTypeDescription;
    /**
     * The javabean property equivalent of database column
     * vw_creditor_xact_hist.xact_amount
     */
    private double xactAmount;
    /**
     * The javabean property equivalent of database column
     * vw_creditor_xact_hist.xact_date
     */
    private java.util.Date xactDate;
    /**
     * The javabean property equivalent of database column
     * vw_creditor_xact_hist.xact_type_id
     */
    private int xactTypeId;
    /**
     * The javabean property equivalent of database column
     * vw_creditor_xact_hist.xact_subtype_id
     */
    private int xactSubtypeId;
    /**
     * The javabean property equivalent of database column
     * vw_creditor_xact_hist.reason
     */
    private String reason;
    /**
     * The javabean property equivalent of database column
     * vw_creditor_xact_hist.xact_type_name
     */
    private String xactTypeName;
    /**
     * The javabean property equivalent of database column
     * vw_creditor_xact_hist.date_created
     */
    private java.util.Date dateCreated;
    /**
     * The javabean property equivalent of database column
     * vw_creditor_xact_hist.user_id
     */
    private String userId;
    /**
     * The javabean property equivalent of database column
     * vw_creditor_xact_hist.posted_date
     */
    private java.util.Date postedDate;
    /**
     * The javabean property equivalent of database column
     * vw_creditor_xact_hist.confirm_no
     */
    private String confirmNo;
    /**
     * The javabean property equivalent of database column
     * vw_creditor_xact_hist.neg_instr_no
     */
    private String negInstrNo;
    /**
     * The javabean property equivalent of database column
     * vw_creditor_xact_hist.tender_id
     */
    private int tenderId;
    /**
     * The javabean property equivalent of database column
     * vw_creditor_xact_hist.document_id
     */
    private int documentId;
    /**
     * The javabean property equivalent of database column
     * vw_creditor_xact_hist.creditor_activity_id
     */
    private int creditorActivityId;
    /**
     * The javabean property equivalent of database column
     * vw_creditor_xact_hist.creditor_activity_amount
     */
