...
public class VwCustomerXactHist extends OrmBean {
    ...
    /**
     * The property name constant equivalent to property, CustomerActivityId, of
     * respective DataSource view.
     */
    public static final String PROP_CUSTOMERACTIVITYID = "CustomerActivityId";
    /**
     * The property name constant equivalent to property,
     * CustomerActivityAmount, of respective DataSource view.
     */
     ...
     * vw_customer_xact_hist.xact_id
     */
    private int xactId;
    /**
     * The javabean property equivalent of database column
     * vw_customer_xact_hist.customer_id
     */
    private int customerId;
    /**
     * The javabean property equivalent of database column
     * vw_customer_xact_hist.person_id
     */
    private int personId;
    /**
     * The javabean property equivalent of database column
     * vw_customer_xact_hist.business_id
     */
    private int businessId;
    /**
     * The javabean property equivalent of database column
     * vw_customer_xact_hist.account_no
     */
    private String accountNo;
    /**
     * The javabean property equivalent of database column
     * vw_customer_xact_hist.credit_limit
     */
    private double creditLimit;
    /**
     * The javabean property equivalent of database column
     * vw_customer_xact_hist.active
     */
    private int active;
    /**
     * The javabean property equivalent of database column
     * vw_customer_xact_hist.xact_amount
     */
    private double xactAmount;
    /**
     * The javabean property equivalent of database column
     * vw_customer_xact_hist.xact_date
     */
    private java.util.Date xactDate;
    /**
     * The javabean property equivalent of database column
     * vw_customer_xact_hist.xact_type_id
     */
    private int xactTypeId;
    /**
     * The javabean property equivalent of database column
     * vw_customer_xact_hist.xact_subtype_id
     */
    private int xactSubtypeId;
    /**
     * The javabean property equivalent of database column
     * vw_customer_xact_hist.reason
     */
    private String reason;
    /**
     * The javabean property equivalent of database column
     * vw_customer_xact_hist.confirm_no
     */
    private String confirmNo;
    /**
     * The javabean property equivalent of database column
     * vw_customer_xact_hist.document_id
     */
    private int documentId;
    /**
     * The javabean property equivalent of database column
     * vw_customer_xact_hist.xact_type_name
     */
    private String xactTypeName;
    /**
     * The javabean property equivalent of database column
     * vw_customer_xact_hist.customer_activity_id
     */
    private int customerActivityId;
    /**
     * The javabean property equivalent of database column
     * vw_customer_xact_hist.customer_activity_amount
     */
