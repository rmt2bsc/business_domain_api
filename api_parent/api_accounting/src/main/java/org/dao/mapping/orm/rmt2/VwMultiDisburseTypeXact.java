...
public boolean equals(Object obj) {
   ...
   final VwMultiDisburseTypeXact other = (VwMultiDisburseTypeXact) obj; 
   ...
   if (EqualityAssistant.notEqual(this.xactTypeItemXactTypeId, other.xactTypeItemXactTypeId)) {
      return false;
   }
...
public String toString() {
   return "VwMultiDisburseTypeXact [xactId=" + xactId + 
