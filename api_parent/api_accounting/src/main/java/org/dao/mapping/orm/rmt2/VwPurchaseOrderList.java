...
public class VwPurchaseOrderList extends OrmBean {
    ...
    /**
     * The property name constant equivalent to property, StatusId, of
     * respective DataSource view.
     */
    public static final String PROP_STATUSID = "StatusId";
    /**
     * The property name constant equivalent to property, RefNo, of respective
     * DataSource view.
     */
    public static final String PROP_REFNO = "RefNo";
    /**
     * The property name constant equivalent to property, Total, of respective
     * DataSource view.
     */
    public static final String PROP_TOTAL = "Total";
    /**
     * The property name constant equivalent to property, StatusDescription, of
     * respective DataSource view.
     */
    public static final String PROP_STATUSDESCRIPTION = "StatusDescription";
    /**
     * The property name constant equivalent to property, StatusHistId, of
     * respective DataSource view.
     */
    public static final String PROP_STATUSHISTID = "StatusHistId";
    /**
     * The property name constant equivalent to property, EffectiveDate, of
     * respective DataSource view.
     */
    public static final String PROP_EFFECTIVEDATE = "EffectiveDate";
    /**
     * The property name constant equivalent to property, EndDate, of respective
     * DataSource view.
     */
    ...
    /**
     * The property name constant equivalent to property, CreditTypeId, of
     * respective DataSource view.
     */
    public static final String PROP_CREDITTYPEID = "CreditTypeId";
    /**
     * The property name constant equivalent to property, CreditorTypeDescr, of
     * respective DataSource view.
     */
     ...
     * vw_purchase_order_list.id
     */
    private int id;
    /**
     * The javabean property equivalent of database column
     * vw_purchase_order_list.vendor_id
     */
    private int vendorId;
    /**
     * The javabean property equivalent of database column
     * vw_purchase_order_list.status_id
     */
    private int statusId;
    /**
     * The javabean property equivalent of database column
     * vw_purchase_order_list.ref_no
     */
    private String refNo;
    /**
     * The javabean property equivalent of database column
     * vw_purchase_order_list.total
     */
    private double total;
    /**
     * The javabean property equivalent of database column
     * vw_purchase_order_list.status_description
     */
    private String statusDescription;
    /**
     * The javabean property equivalent of database column
     * vw_purchase_order_list.status_hist_id
     */
    private int statusHistId;
    /**
     * The javabean property equivalent of database column
     * vw_purchase_order_list.effective_date
     */
    private java.util.Date effectiveDate;
    /**
     * The javabean property equivalent of database column
     * vw_purchase_order_list.end_date
     */
    private java.util.Date endDate;
    /**
     * The javabean property equivalent of database column
     * vw_purchase_order_list.user_id
     */
    private String userId;
    /**
     * The javabean property equivalent of database column
     * vw_purchase_order_list.creditor_id
     */
    private int creditorId;
    /**
     * The javabean property equivalent of database column
     * vw_purchase_order_list.business_id
     */
    private int businessId;
    /**
     * The javabean property equivalent of database column
     * vw_purchase_order_list.account_number
     */
    private String accountNumber;
    /**
     * The javabean property equivalent of database column
     * vw_purchase_order_list.credit_limit
     */
    private double creditLimit;
    /**
     * The javabean property equivalent of database column
     * vw_purchase_order_list.credit_type_id
     */
    private int creditTypeId;
    /**
     * The javabean property equivalent of database column
     * vw_purchase_order_list.creditor_type_descr
     */
