...
public class VwSalesOrderInvoice extends OrmBean {
    ...
    // VwSalesOrderInvoiceView

    /**
     * The property name constant equivalent to property, SalesOrderId, of
    ...
    /**
     * The property name constant equivalent to property, SalesOrderDate, of
     * respective DataSource view.
     */
    ...
    /**
     * The property name constant equivalent to property, InvoiceDate, of
     * respective DataSource view.
     */
    public static final String PROP_INVOICEDATE = "InvoiceDate";
    /**
     * The property name constant equivalent to property, OrderTotal, of
     * respective DataSource view.
     */
     ...
     * vw_sales_order_invoice.sales_order_id
     */
    private int salesOrderId;
    /**
     * The javabean property equivalent of database column
     * vw_sales_order_invoice.customer_id
     */
    private int customerId;
    /**
     * The javabean property equivalent of database column
     * vw_sales_order_invoice.invoiced
     */
    ...
    /**
     * The javabean property equivalent of database column
     * vw_sales_order_invoice.sales_order_date
     */
    private java.util.Date salesOrderDate;
    /**
     * The javabean property equivalent of database column
     * vw_sales_order_invoice.invoice_id
     */
    private int invoiceId;
    /**
     * The javabean property equivalent of database column
     * vw_sales_order_invoice.xact_id
     */
    private int xactId;
    /**
     * The javabean property equivalent of database column
     * vw_sales_order_invoice.invoice_no
     */
    private String invoiceNo;
    /**
     * The javabean property equivalent of database column
     * vw_sales_order_invoice.invoice_date
     */
    private java.util.Date invoiceDate;
    /**
     * The javabean property equivalent of database column
     * vw_sales_order_invoice.order_total
     */
    private double orderTotal;
    /**
     * The javabean property equivalent of database column
     * vw_sales_order_invoice.acct_id
     */
    private int acctId;
    /**
     * The javabean property equivalent of database column
     * vw_sales_order_invoice.account_no
     */
    private String accountNo;
    /**
     * The javabean property equivalent of database column
     * vw_sales_order_invoice.credit_limit
     */
    private double creditLimit;
    /**
     * The javabean property equivalent of database column
     * vw_sales_order_invoice.description
     */
