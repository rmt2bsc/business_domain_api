...
public boolean equals(Object obj) {
   ...
   final VwVendorItemPurchaseOrderItem other = (VwVendorItemPurchaseOrderItem) obj; 
   ...
   if (EqualityAssistant.notEqual(this.qtyOrderd, other.qtyOrderd)) {
      return false;
   }
   if (EqualityAssistant.notEqual(this.actualUnitCost, other.actualUnitCost)) {
      return false;
   }
   if (EqualityAssistant.notEqual(this.qtyReceived, other.qtyReceived)) {
      return false;
   }
   if (EqualityAssistant.notEqual(this.qtyReturned, other.qtyReturned)) {
      return false;
   }
   return true; 
} 
...
public int hashCode() {
   return HashCodeAssistant.combineHashCodes(HashCodeAssistant.hashObject(this.itemId),
               ...
               HashCodeAssistant.hashObject(this.qtyOrderd),
               HashCodeAssistant.hashObject(this.actualUnitCost),
               HashCodeAssistant.hashObject(this.qtyReceived),
               HashCodeAssistant.hashObject(this.qtyReturned));
} 

@Override
public String toString() {
   return "VwVendorItemPurchaseOrderItem [itemId=" + itemId + 
          ", vendorId=" + vendorId + 
