...
public class VwXactItemList extends OrmBean {
    ...
    /**
     * The property name constant equivalent to property, ItemActivityId, of
    ...
    /**
     * The property name constant equivalent to property, ItemXactReason, of
     * respective DataSource view.
     */
     ...
     * vw_xact_item_list.item_activity_id
     */
    private int itemActivityId;
    /**
     * The javabean property equivalent of database column
     * vw_xact_item_list.xact_type_item_id
     */
    private int xactTypeItemId;
    /**
     * The javabean property equivalent of database column
     * vw_xact_item_list.xact_id
     */
    private int xactId;
    /**
     * The javabean property equivalent of database column
     * vw_xact_item_list.xact_type_id
     */
    private int xactTypeId;
    /**
     * The javabean property equivalent of database column
     * vw_xact_item_list.amount
     */
    private double amount;
    /**
     * The javabean property equivalent of database column
     * vw_xact_item_list.name
     */
    private String name;
    /**
     * The javabean property equivalent of database column
     * vw_xact_item_list.item_xact_reason
     */
