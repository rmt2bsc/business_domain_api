...
public boolean equals(Object obj) {
   ...
   if (EqualityAssistant.notEqual(this.bankTransInd, other.bankTransInd)) {
      return false;
   }
   if (EqualityAssistant.notEqual(this.confirmNo, other.confirmNo)) {
      return false;
   }
   if (EqualityAssistant.notEqual(this.entityRefNo, other.entityRefNo)) {
      return false;
   }
...
public int hashCode() {
   return HashCodeAssistant.combineHashCodes(HashCodeAssistant.hashObject(this.xactId),
               ...
               HashCodeAssistant.hashObject(this.bankTransInd),
