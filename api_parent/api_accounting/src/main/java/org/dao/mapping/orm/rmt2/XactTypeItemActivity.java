...
public class XactTypeItemActivity extends OrmBean {
    ...
    // XactTypeItemActivityView

    /**
     * The property name constant equivalent to property, XactTypeItemActvId, of
    ...
    /**
     * The property name constant equivalent to property, XactItemId, of
     * respective DataSource view.
     */
     ...
     * xact_type_item_activity.xact_type_item_actv_id
     */
    private int xactTypeItemActvId;
    /**
     * The javabean property equivalent of database column
     * xact_type_item_activity.xact_id
     */
    private int xactId;
    /**
     * The javabean property equivalent of database column
     * xact_type_item_activity.xact_item_id
     */
    private int xactItemId;
    /**
     * The javabean property equivalent of database column
     * xact_type_item_activity.amount
     */
    private double amount;
    /**
     * The javabean property equivalent of database column
     * xact_type_item_activity.description
     */
    private String description;
    /**
     * The javabean property equivalent of database column
     * xact_type_item_activity.date_created
     */
    private java.util.Date dateCreated;
    /**
     * The javabean property equivalent of database column
     * xact_type_item_activity.date_updated
     */
    private java.util.Date dateUpdated;
    /**
     * The javabean property equivalent of database column
     * xact_type_item_activity.user_id
     */
    private String userId;
    /**
     * The javabean property equivalent of database column
     * xact_type_item_activity.ip_created
     */
    private String ipCreated;
    /**
     * The javabean property equivalent of database column
     * xact_type_item_activity.ip_updated
     */
