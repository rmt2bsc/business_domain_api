 ...
 * 
 */
public class Rmt2InventoryDtoFactory extends RMT2Base {
     ...
     * Create an instance of <i>VendorItemDto</i>.
     * <p>
     * A brand new instance of VendorItemDto is created using integer as vendor
     * id and an <i>ItemMasterDto</i> object.
     * 
     * @param vendorId
     *            the vendor's id
     * @param item
