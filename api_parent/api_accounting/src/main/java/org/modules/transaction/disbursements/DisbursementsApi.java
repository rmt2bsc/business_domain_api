...
public interface DisbursementsApi extends XactApi {
     ...
     */
    List<XactDto> getByTransaction(String criteria) throws DisbursementsApiException;
     ...
     */
    List<XactTypeItemActivityDto> getByTransactionItem(String criteria) throws DisbursementsApiException;
    ...
    /**
     * Creates a creditor related cash disbursement transaction or reverses an
     * existing one.
     * 
     * @param xact
     *            The target transaction
     ...
     * @throws DisbursementsDaoException
     */
    int updateDisbursement(XactDto xact, List<XactTypeItemActivityDto> items, int creditorId)
            throws DisbursementsApiException;
}
