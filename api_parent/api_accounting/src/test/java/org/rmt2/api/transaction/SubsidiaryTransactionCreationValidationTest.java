...
/**
 * Tests the general validations pertaining to subsidiary transaction creation.
 * 
 * @author rterrell
 * 
 */
...
public class SubsidiaryTransactionCreationValidationTest extends TransactionApiTestData {
    ...
    public void testTransactionWithNullSubsidiaryId() {
        ...
        try {
            api.createSubsidiaryTransaction(null, 111111, 111.11);
    ...
    public void testTransactionWithNullXactId() {
        ...
        XactApi api = f.createDefaultXactApi(mockDaoClient);
        try {
            api.createSubsidiaryTransaction(200, null, 111.11);
    ...
    public void testTransactionWithNullAmount() {
        ...
        XactApi api = f.createDefaultXactApi(mockDaoClient);
        try {
            api.createSubsidiaryTransaction(200, 111111, null);
    ...
    public void testTransactionWithZeroSubsidiaryId() {
        ...
        XactApi api = f.createDefaultXactApi(mockDaoClient);
        try {
            api.createSubsidiaryTransaction(0, 111111, 111.11);
    ...
    public void testTransactionWithZeroXactId() {
        ...
        XactApi api = f.createDefaultXactApi(mockDaoClient);
        try {
            api.createSubsidiaryTransaction(200, 0, 111.11);
    ...
    public void testTransactionWithNegativeSubsidiaryId() {
        ...
        XactApi api = f.createDefaultXactApi(mockDaoClient);
        try {
            api.createSubsidiaryTransaction(-100, 111111, 111.11);
    ...
    public void testXactRecordNotFound() {
        ...
        XactApi api = f.createDefaultXactApi(mockDaoClient);
        try {
            api.createSubsidiaryTransaction(200, 222222, 111.11);
