...
@PrepareForTest({ AbstractDaoClientImpl.class, Rmt2OrmClientFactory.class,
        ResultSet.class })
public class CreditorPurchaseQueryApiTest extends TransactionApiTestData {
    ...
    public void testFetchAll_WithNullCustomSqlCriteria() {
        ...
        mockCriteria.setXactTypeId(XactConst.XACT_TYPE_CREDITOR_PURCHASE);
        try {
        ...
        try {
            criteria.setXactTypeId(XactConst.XACT_TYPE_CREDITOR_PURCHASE);
