...
public class VendorPurchaseApiTestData extends TransactionApiTestData {
    ...
    private List<PurchaseOrder> createMockSinglePurchaseOrder() {
        ...
        PurchaseOrder o = AccountingMockDataFactory.createPurchaseOrder(330,
    ...
    private List<PurchaseOrder> createMockPurchaseOrders() {
        ...
        o = AccountingMockDataFactory.createPurchaseOrder(331, 7000, 1111111,
                200.00, "331-0000-0000-0000");
        list.add(o);

        o = AccountingMockDataFactory.createPurchaseOrder(332, 7000, 1111111,
                300.00, "332-0000-0000-0000");
        list.add(o);

        o = AccountingMockDataFactory.createPurchaseOrder(333, 7000, 1111111,
                400.00, "333-0000-0000-0000");
        list.add(o);

        o = AccountingMockDataFactory.createPurchaseOrder(334, 7000, 1111111,
    ...
    private List<PurchaseOrderItems> createMockPurchaseOrderItem() {
        ...
        PurchaseOrderItems o = AccountingMockDataFactory.createPurchaseOrderItem(8880, 330, 100, 100.00, 11, 4, 0);
        list.add(o);
        return list;
    }
    ...
    private List<PurchaseOrderItems> createMockPurchaseOrderItems() {
        ...
        o =  AccountingMockDataFactory.createPurchaseOrderItem(8881, 330, 101, 200.00, 10, 3, 0);
        list.add(o);

        o = AccountingMockDataFactory.createPurchaseOrderItem(8882, 330, 102, 300.00, 9, 2, 0);
        list.add(o);

        o = AccountingMockDataFactory.createPurchaseOrderItem(8883, 330, 103, 400.00, 8, 1, 0);
        list.add(o);

        o = AccountingMockDataFactory.createPurchaseOrderItem(8884, 330, 104, 500.00, 7, 0, 5);
        list.add(o);
        return list;
    }
    ...
    private List<VendorItems> createMockVendorItem() {
        ...
        VendorItems o = AccountingMockDataFactory.createVendorItems(8880, 1111111, "111-111", "111-ABC", 90.00);
        list.add(o);
        return list;
    }
    ...
    private List<VendorItems> createMockVendorItems() {
        ...
        o =  AccountingMockDataFactory.createVendorItems(8881, 1111111, "111-222", "222-ABC", 80.00);
        list.add(o);

        o = AccountingMockDataFactory.createVendorItems(8882, 1111111, "111-333", "333-ABC", 70.00);
        list.add(o);

        o = AccountingMockDataFactory.createVendorItems(8883, 1111111, "111-444", "444-ABC", 60.00);
        list.add(o);

        o = AccountingMockDataFactory.createVendorItems(8884, 1111111, "111-555", "555-ABC", 50.00);
        list.add(o);
        return list;
    }
    ...
    private List<VwVendorItemPurchaseOrderItem> createMockVwVendorItemPurchaseOrderItems() {
        ...
        VwVendorItemPurchaseOrderItem o = AccountingMockDataFactory
                .createVwVendorItemPurchaseOrderItem(330, 8880, 1111111, 100.00,
                        10, 100, 0, 0, 0);
        list.add(o);

        o = AccountingMockDataFactory.createVwVendorItemPurchaseOrderItem(330,
    ...
    private List<VwVendorItems> createMockSingleVwVendorItems() {
        ...
        VwVendorItems o = AccountingMockDataFactory.createVwVendorItems(8880,
                1111111, 90.00, 100, 0);
        list.add(o);
        return list;
    }
    ...
    private List<VwVendorItems> createMockVwVendorItems() {
        ...
        o = AccountingMockDataFactory.createVwVendorItems(8881, 1111111, 91.00,
                101, 0);
        list.add(o);

        o = AccountingMockDataFactory.createVwVendorItems(8882, 1111111, 92.00,
                102, 0);
        list.add(o);

        o = AccountingMockDataFactory.createVwVendorItems(8883, 1111111, 93.00,
                103, 0);
        list.add(o);

        o = AccountingMockDataFactory.createVwVendorItems(8884, 1111111, 94.00,
                104, 0);
        list.add(o);
        return list;
    }
    ...
    private List<PurchaseOrderStatus> createMockPurchaseOrderStatus() {
        ...
        PurchaseOrderStatus o = AccountingMockDataFactory
    ...
    private List<PurchaseOrderStatus> createMockPurchaseOrderStatuses() {
        ...
        o = AccountingMockDataFactory.createPurchaseOrderStatus(
    ...
    private List<PurchaseOrderStatusHist> createMockPurchaseOrderCurrentStatusHistory() {
        ...
        PurchaseOrderStatusHist o = AccountingMockDataFactory
    ...
    private List<PurchaseOrderStatusHist> createMockPurchaseOrderStatusHistory() {
        ...
        o = AccountingMockDataFactory.createPurchaseOrderStatusHist(2,
                VendorPurchasesConst.PURCH_STATUS_QUOTE, 330, "2017-02-02",
                "2017-02-02");
        list.add(o);

        o = AccountingMockDataFactory.createPurchaseOrderStatusHist(3,
                VendorPurchasesConst.PURCH_STATUS_RECEIVED, 330, "2017-03-03",
                "2017-03-03");
        list.add(o);

        o = AccountingMockDataFactory.createPurchaseOrderStatusHist(4,
    ...
    private List<ItemMaster> createMockItemMaster() {
        ...
        ItemMaster p = AccountingMockDataFactory.createMockOrmItemMaster(100, 2,
    ...
    private List<ItemMasterType> createMockItemMasterType() {
        ...
        ItemMasterType p = AccountingMockDataFactory.createMockOrmItemMasterType(2, "Item Type Merchandise");
        list.add(p);
        return list;
    }
}
