...
public class UserConnectXref extends OrmBean {
    ...
    /**
     * The property name constant equivalent to property, ConId, of respective
     * DataSource view.
     */
    public static final String PROP_CONID = "ConId";
    /**
     * The property name constant equivalent to property, ConUserId, of
     * respective DataSource view.
     */
    public static final String PROP_CONUSERID = "ConUserId";
    /**
     * The property name constant equivalent to property, AppUserId, of
     * respective DataSource view.
     */
     ...
     * user_connect_xref.con_id
     */
    private String conId;
    /**
     * The javabean property equivalent of database column
     * user_connect_xref.con_user_id
     */
    private String conUserId;
    /**
     * The javabean property equivalent of database column
     * user_connect_xref.app_user_id
     */
