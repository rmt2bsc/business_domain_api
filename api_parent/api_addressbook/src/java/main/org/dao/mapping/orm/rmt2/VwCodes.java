...
public class VwCodes extends OrmBean {
    ...
    /**
     * The property name constant equivalent to property, GroupDesc, of
    ...
    /**
     * The property name constant equivalent to property, CodeShortdesc, of
     * respective DataSource view.
     */
    public static final String PROP_CODESHORTDESC = "CodeShortdesc";
    /**
     * The property name constant equivalent to property, CodeLongdesc, of
     * respective DataSource view.
     */
     ...
     * vw_codes.code_shortdesc
     */
    private String codeShortdesc;
    /**
     * The javabean property equivalent of database column
     * vw_codes.code_longdesc
     */
