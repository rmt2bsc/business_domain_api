...
public class ContactsApiTest {
    ...
    public void testFetchCommonSinglePersonal() {
        ...
        String contactName = "Terrell, Roy Jr";
        try {
            results = this.api.getontact(985);
        } catch (Exception e) {
            e.printStackTrace();
            Assert.fail(e.getMessage());
        }
    ...
    public void testFetchCommonSingleBusiness() {
        ...
        try {
            results = this.api.getontact(1117);
        } catch (Exception e) {
            e.printStackTrace();
            Assert.fail(e.getMessage());
        }
    ...
    public void testFetchCommonByContactName() {
        ...
        List<ContactDto> results = null;
        try {
            results = this.api.getContact(criteria);
        } catch (Exception e) {
            e.printStackTrace();
            Assert.fail(e.getMessage());
        }
    ...
    public void testFetchContactWithInvalidCriteria() {
        Object results = null;
        try {
            results = this.api.getContact(null);
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public void testCreateUpdateDeletePersonAsCommonContact() {
        ...
        try {
            newId = this.api.updateContact(contact);
        } catch (Exception e) {
            e.printStackTrace();
            Assert.fail(e.getMessage());
        }
        ...
        try {
            contact = this.api.getontact(contact.getContactId());
        } catch (Exception e) {
            Assert.fail(e.getMessage());
        }
        Assert.assertEquals(newId, contact.getContactId());
        ...
        try {
            rc = this.api.updateContact(contact);
        } catch (Exception e) {
            e.printStackTrace();
            Assert.fail(e.getMessage());
        }
        ...
        try {
            contactUpdate = this.api.getontact(newId);
        } catch (Exception e) {
            Assert.fail(e.getMessage());
        }
        Assert.assertEquals(newId, contact.getContactId());
        ...
        // Delete contact
        try {
            rc = this.api.deleteContact(contactUpdate);
        } catch (Exception e) {
            Assert.fail(e.getMessage());
        }
    ...
    public void testCreatePersonAsCommonContactWithNullName() {
        ...
        try {
            newId = this.api.updateContact(newContact);
        } catch (Exception e) {
            e.printStackTrace();
            Assert.assertTrue(newId == 0);
            return;
    ...
    public void testCreateUpdateDeletePersonContact() {
        ...
        try {
            ...
            list = this.api.getContact(criteria);
    ...
    public void testFetchBusinesContactsUsingMultipleBusinessId() {
        ...
        try {
            this.createListData();
            list = this.api.getBusinessContact(this.busIdList);
        } catch (Exception e) {
            e.printStackTrace();
            Assert.fail(e.getMessage());
        } finally {
    ...
    private void deleteListData() {
        ...
        for (int ndx = 0; ndx < busIdList.size(); ndx++) {
            ...
            try {
                rc = this.api.deleteContact(contact);
            } catch (Exception e) {
                Assert.fail(e.getMessage());
            }
