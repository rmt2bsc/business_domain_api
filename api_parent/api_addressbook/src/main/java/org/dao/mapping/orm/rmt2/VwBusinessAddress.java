...
/** The property name constant equivalent to property, BusServTypeGrpId, of respective DataSource view. */
  public static final String PROP_BUSSERVTYPEGRPID = "BusServTypeGrpId";
/** The property name constant equivalent to property, BusServTypeShortdesc, of respective DataSource view. */
  public static final String PROP_BUSSERVTYPESHORTDESC = "BusServTypeShortdesc";
/** The property name constant equivalent to property, BusServTypeLongdesc, of respective DataSource view. */
  public static final String PROP_BUSSERVTYPELONGDESC = "BusServTypeLongdesc";
...
/** The property name constant equivalent to property, BusEntityTypeGrpId, of respective DataSource view. */
  public static final String PROP_BUSENTITYTYPEGRPID = "BusEntityTypeGrpId";
/** The property name constant equivalent to property, BusEntityTypeShortdesc, of respective DataSource view. */
  public static final String PROP_BUSENTITYTYPESHORTDESC = "BusEntityTypeShortdesc";
/** The property name constant equivalent to property, BusEntityTypeLongdesc, of respective DataSource view. */
  public static final String PROP_BUSENTITYTYPELONGDESC = "BusEntityTypeLongdesc";
...
/** The javabean property equivalent of database column vw_business_address.bus_serv_type_grp_id */
  private int busServTypeGrpId;
/** The javabean property equivalent of database column vw_business_address.bus_serv_type_shortdesc */
  private String busServTypeShortdesc;
/** The javabean property equivalent of database column vw_business_address.bus_serv_type_longdesc */
  private String busServTypeLongdesc;
/** The javabean property equivalent of database column vw_business_address.bus_entity_type_id */
  private int busEntityTypeId;
/** The javabean property equivalent of database column vw_business_address.bus_entity_type_grp_id */
  private int busEntityTypeGrpId;
/** The javabean property equivalent of database column vw_business_address.bus_entity_type_shortdesc */
  private String busEntityTypeShortdesc;
/** The javabean property equivalent of database column vw_business_address.bus_entity_type_longdesc */
  private String busEntityTypeLongdesc;
...
/**
 * Sets the value of member variable busServTypeGrpId
 */
  public void setBusServTypeGrpId(int value) {
    this.busServTypeGrpId = value;
  }
/**
 * Gets the value of member variable busServTypeGrpId
 */
  public int getBusServTypeGrpId() {
    return this.busServTypeGrpId;
  }
/**
 * Sets the value of member variable busServTypeShortdesc
 */
  public void setBusServTypeShortdesc(String value) {
    this.busServTypeShortdesc = value;
  }
/**
 * Gets the value of member variable busServTypeShortdesc
 */
  public String getBusServTypeShortdesc() {
    return this.busServTypeShortdesc;
  }
/**
 * Sets the value of member variable busServTypeLongdesc
 */
  public void setBusServTypeLongdesc(String value) {
    this.busServTypeLongdesc = value;
  }
/**
 * Gets the value of member variable busServTypeLongdesc
 */
  public String getBusServTypeLongdesc() {
    return this.busServTypeLongdesc;
  }
/**
...
/**
 * Sets the value of member variable busEntityTypeGrpId
 */
  public void setBusEntityTypeGrpId(int value) {
    this.busEntityTypeGrpId = value;
  }
/**
 * Gets the value of member variable busEntityTypeGrpId
 */
  public int getBusEntityTypeGrpId() {
    return this.busEntityTypeGrpId;
  }
/**
 * Sets the value of member variable busEntityTypeShortdesc
 */
  public void setBusEntityTypeShortdesc(String value) {
    this.busEntityTypeShortdesc = value;
  }
/**
 * Gets the value of member variable busEntityTypeShortdesc
 */
  public String getBusEntityTypeShortdesc() {
    return this.busEntityTypeShortdesc;
  }
/**
 * Sets the value of member variable busEntityTypeLongdesc
 */
  public void setBusEntityTypeLongdesc(String value) {
    this.busEntityTypeLongdesc = value;
  }
/**
 * Gets the value of member variable busEntityTypeLongdesc
 */
  public String getBusEntityTypeLongdesc() {
    return this.busEntityTypeLongdesc;
  }
/**
...
public boolean equals(Object obj) {
   ...
   if (EqualityAssistant.notEqual(this.busServTypeGrpId, other.busServTypeGrpId)) {
      return false;
   }
   if (EqualityAssistant.notEqual(this.busServTypeShortdesc, other.busServTypeShortdesc)) {
      return false;
   }
   if (EqualityAssistant.notEqual(this.busServTypeLongdesc, other.busServTypeLongdesc)) {
      return false;
   }
   if (EqualityAssistant.notEqual(this.busEntityTypeId, other.busEntityTypeId)) {
      return false;
   }
   if (EqualityAssistant.notEqual(this.busEntityTypeGrpId, other.busEntityTypeGrpId)) {
      return false;
   }
   if (EqualityAssistant.notEqual(this.busEntityTypeShortdesc, other.busEntityTypeShortdesc)) {
      return false;
   }
   if (EqualityAssistant.notEqual(this.busEntityTypeLongdesc, other.busEntityTypeLongdesc)) {
      return false;
   }
...
public int hashCode() {
   return HashCodeAssistant.combineHashCodes(HashCodeAssistant.hashObject(this.businessId),
               ...
               HashCodeAssistant.hashObject(this.busServTypeGrpId),
               HashCodeAssistant.hashObject(this.busServTypeShortdesc),
               HashCodeAssistant.hashObject(this.busServTypeLongdesc),
               HashCodeAssistant.hashObject(this.busEntityTypeId),
               HashCodeAssistant.hashObject(this.busEntityTypeGrpId),
               HashCodeAssistant.hashObject(this.busEntityTypeShortdesc),
               HashCodeAssistant.hashObject(this.busEntityTypeLongdesc),
...
public String toString() {
   return "VwBusinessAddress [businessId=" + businessId + 
          ", addrId=" + addrId + 
          ...
          ", busServTypeGrpId=" + busServTypeGrpId + 
          ", busServTypeShortdesc=" + busServTypeShortdesc + 
          ", busServTypeLongdesc=" + busServTypeLongdesc + 
          ", busEntityTypeId=" + busEntityTypeId + 
          ", busEntityTypeGrpId=" + busEntityTypeGrpId + 
          ", busEntityTypeShortdesc=" + busEntityTypeShortdesc + 
          ", busEntityTypeLongdesc=" + busEntityTypeLongdesc + 
