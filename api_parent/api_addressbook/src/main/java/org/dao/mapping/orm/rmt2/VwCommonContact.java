...
public boolean equals(Object obj) {
   ...
   final VwCommonContact other = (VwCommonContact) obj; 
   if (EqualityAssistant.notEqual(this.contactId, other.contactId)) {
      return false;
   }
   if (EqualityAssistant.notEqual(this.contactName, other.contactName)) {
      return false;
   }
   if (EqualityAssistant.notEqual(this.contactType, other.contactType)) {
      return false;
   }
...
public String toString() {
   return "VwCommonContact [contactId=" + contactId + 
