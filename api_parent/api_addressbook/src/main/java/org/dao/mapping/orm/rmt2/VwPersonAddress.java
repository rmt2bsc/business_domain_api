...
public boolean equals(Object obj) {
   ...
   final VwPersonAddress other = (VwPersonAddress) obj; 
   ...
   if (EqualityAssistant.notEqual(this.perBirthDate, other.perBirthDate)) {
      return false;
   }
   if (EqualityAssistant.notEqual(this.perEmail, other.perEmail)) {
      return false;
   }
   if (EqualityAssistant.notEqual(this.perFirstname, other.perFirstname)) {
      return false;
   }
   if (EqualityAssistant.notEqual(this.perGenderId, other.perGenderId)) {
      return false;
   }
   if (EqualityAssistant.notEqual(this.perGeneration, other.perGeneration)) {
      return false;
   }
   if (EqualityAssistant.notEqual(this.perLastname, other.perLastname)) {
      return false;
   }
   if (EqualityAssistant.notEqual(this.perMaidenname, other.perMaidenname)) {
      return false;
   }
   if (EqualityAssistant.notEqual(this.perMaritalStatus, other.perMaritalStatus)) {
      return false;
   }
   if (EqualityAssistant.notEqual(this.perMidname, other.perMidname)) {
      return false;
   }
   if (EqualityAssistant.notEqual(this.perRaceId, other.perRaceId)) {
      return false;
   }
   if (EqualityAssistant.notEqual(this.perShortname, other.perShortname)) {
      return false;
   }
   if (EqualityAssistant.notEqual(this.perSsn, other.perSsn)) {
      return false;
   }
   if (EqualityAssistant.notEqual(this.perTitle, other.perTitle)) {
      return false;
   }
...
public int hashCode() {
   return HashCodeAssistant.combineHashCodes(HashCodeAssistant.hashObject(this.addrId),
               ...
               HashCodeAssistant.hashObject(this.perBirthDate),
               HashCodeAssistant.hashObject(this.perEmail),
               HashCodeAssistant.hashObject(this.perFirstname),
               HashCodeAssistant.hashObject(this.perGenderId),
               HashCodeAssistant.hashObject(this.perGeneration),
               HashCodeAssistant.hashObject(this.perLastname),
               HashCodeAssistant.hashObject(this.perMaidenname),
               HashCodeAssistant.hashObject(this.perMaritalStatus),
               HashCodeAssistant.hashObject(this.perMidname),
               HashCodeAssistant.hashObject(this.perRaceId),
               HashCodeAssistant.hashObject(this.perShortname),
               HashCodeAssistant.hashObject(this.perSsn),
               HashCodeAssistant.hashObject(this.perTitle),
               HashCodeAssistant.hashObject(this.personId));
} 

@Override
public String toString() {
   return "VwPersonAddress [addrId=" + addrId + 
          ...
          ", perGenderId=" + perGenderId + 
          ", perGeneration=" + perGeneration + 
          ", perLastname=" + perLastname + 
          ", perMaidenname=" + perMaidenname + 
          ", perMaritalStatus=" + perMaritalStatus + 
          ", perMidname=" + perMidname + 
          ", perRaceId=" + perRaceId + 
          ", perShortname=" + perShortname + 
          ", perSsn=" + perSsn + 
          ", perTitle=" + perTitle + 
          ", personId=" + personId  + "]";
}
