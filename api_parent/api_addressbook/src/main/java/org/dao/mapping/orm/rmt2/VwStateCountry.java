...
public class VwStateCountry extends OrmBean {
    ...
    /**
     * The property name constant equivalent to property, StateId, of respective
     * DataSource view.
     */
    public static final String PROP_STATEID = "StateId";
    /**
     * The property name constant equivalent to property, StateCode, of
    ...
    /**
     * The property name constant equivalent to property, StateName, of
     * respective DataSource view.
     */
    public static final String PROP_STATENAME = "StateName";
    /**
     * The property name constant equivalent to property, SttVoidInd, of
     * respective DataSource view.
     */
    public static final String PROP_STTVOIDIND = "SttVoidInd";
    /**
     * The property name constant equivalent to property, CountryName, of
     * respective DataSource view.
     */
     ...
     * vw_state_country.state_id
     */
    private int stateId;
    /**
     * The javabean property equivalent of database column
     * vw_state_country.state_code
     */
    private String stateCode;
    /**
     * The javabean property equivalent of database column
     * vw_state_country.country_id
     */
    private int countryId;
    /**
     * The javabean property equivalent of database column
     * vw_state_country.state_name
     */
    private String stateName;
    /**
     * The javabean property equivalent of database column
     * vw_state_country.stt_void_ind
     */
    private String sttVoidInd;
    /**
     * The javabean property equivalent of database column
     * vw_state_country.country_name
     */
