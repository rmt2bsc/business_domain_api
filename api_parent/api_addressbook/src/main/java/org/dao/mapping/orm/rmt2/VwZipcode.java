...
public class VwZipcode extends OrmBean {
    ...
    /**
     * The property name constant equivalent to property, CountyFips, of
     * respective DataSource view.
     */
    public static final String PROP_COUNTYFIPS = "CountyFips";
    /**
     * The property name constant equivalent to property, TimeZone, of
     * respective DataSource view.
     */
    public static final String PROP_TIMEZONE = "TimeZone";
    /**
     * The property name constant equivalent to property, DayLightSaving, of
     * respective DataSource view.
     */
    ...
    /**
     * The property name constant equivalent to property, Elevation, of
     * respective DataSource view.
     */
    public static final String PROP_ELEVATION = "Elevation";
    /**
     * The property name constant equivalent to property, Msa, of respective
     * DataSource view.
     */
    public static final String PROP_MSA = "Msa";
    /**
     * The property name constant equivalent to property, Pmsa, of respective
     * DataSource view.
     */
    public static final String PROP_PMSA = "Pmsa";
    /**
     * The property name constant equivalent to property, Cbsa, of respective
     * DataSource view.
     */
    public static final String PROP_CBSA = "Cbsa";
    /**
     * The property name constant equivalent to property, CbsaDiv, of respective
     * DataSource view.
     */
    public static final String PROP_CBSADIV = "CbsaDiv";
    /**
     * The property name constant equivalent to property, PersonsPerHousehold,
     * of respective DataSource view.
     */
    public static final String PROP_PERSONSPERHOUSEHOLD = "PersonsPerHousehold";
    /**
     * The property name constant equivalent to property, ZipcodePopulation, of
     * respective DataSource view.
     */
    public static final String PROP_ZIPCODEPOPULATION = "ZipcodePopulation";
    /**
     * The property name constant equivalent to property, CountiesArea, of
     * respective DataSource view.
     */
    public static final String PROP_COUNTIESAREA = "CountiesArea";
    /**
     * The property name constant equivalent to property, HouseholdsPerZipcode,
     * of respective DataSource view.
     */
    public static final String PROP_HOUSEHOLDSPERZIPCODE = "HouseholdsPerZipcode";
    /**
     * The property name constant equivalent to property, WhitePopulation, of
     * respective DataSource view.
     */
    public static final String PROP_WHITEPOPULATION = "WhitePopulation";
    /**
     * The property name constant equivalent to property, BlackPopulation, of
     * respective DataSource view.
     */
    public static final String PROP_BLACKPOPULATION = "BlackPopulation";
    /**
     * The property name constant equivalent to property, HispanicPopulation, of
     * respective DataSource view.
     */
    public static final String PROP_HISPANICPOPULATION = "HispanicPopulation";
    /**
     * The property name constant equivalent to property, IncomePerHousehold, of
     * respective DataSource view.
     */
    public static final String PROP_INCOMEPERHOUSEHOLD = "IncomePerHousehold";
    /**
     * The property name constant equivalent to property, AverageHouseValue, of
     * respective DataSource view.
     */
    public static final String PROP_AVERAGEHOUSEVALUE = "AverageHouseValue";
    /**
     * The property name constant equivalent to property, TimezoneDescr, of
     * respective DataSource view.
     */
    public static final String PROP_TIMEZONEDESCR = "TimezoneDescr";
    /**
     * The property name constant equivalent to property, CitytypeDescr, of
     * respective DataSource view.
     */
    public static final String PROP_CITYTYPEDESCR = "CitytypeDescr";
    /**
     * The property name constant equivalent to property, ZipId, of respective
     * DataSource view.
     */
    ...
    /**
     * The property name constant equivalent to property, CityAliasName, of
     * respective DataSource view.
     */
    public static final String PROP_CITYALIASNAME = "CityAliasName";
    /**
     * The property name constant equivalent to property, CityAliasAbbr, of
     * respective DataSource view.
     */
    ...
    /**
     * The property name constant equivalent to property, CountyName, of
     * respective DataSource view.
     */
    ...
    /**
     * The javabean property equivalent of database column
     * vw_zipcode.city_alias_name
     */
    private String cityAliasName;
    /**
     * The javabean property equivalent of database column
     * vw_zipcode.city_alias_abbr
     */
    private String cityAliasAbbr;
    /**
     * The javabean property equivalent of database column
     * vw_zipcode.city_type_id
     */
    private String cityTypeId;
    /**
     * The javabean property equivalent of database column
     * vw_zipcode.county_name
     */
