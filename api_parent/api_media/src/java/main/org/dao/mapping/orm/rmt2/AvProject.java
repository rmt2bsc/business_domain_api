...
public class AvProject extends OrmBean {
    ...
    /**
     * The property name constant equivalent to property, ArtistId, of
     * respective DataSource view.
     */
    public static final String PROP_ARTISTID = "ArtistId";
    /**
     * The property name constant equivalent to property, ProjectTypeId, of
     * respective DataSource view.
     */
    public static final String PROP_PROJECTTYPEID = "ProjectTypeId";
    /**
     * The property name constant equivalent to property, GenreId, of respective
     * DataSource view.
     */
    public static final String PROP_GENREID = "GenreId";
    /**
     * The property name constant equivalent to property, MediaTypeId, of
     * respective DataSource view.
     */
    ...
    /**
     * The property name constant equivalent to property, MasterDupId, of
     * respective DataSource view.
     */
    public static final String PROP_MASTERDUPID = "MasterDupId";
    /**
     * The property name constant equivalent to property, Ripped, of respective
     * DataSource view.
     */
    public static final String PROP_RIPPED = "Ripped";
    /**
     * The property name constant equivalent to property, Cost, of respective
     * DataSource view.
     */
    ...
    /**
     * The javabean property equivalent of database column
     * av_project.date_created
     */
    private java.util.Date dateCreated;
    /**
     * The javabean property equivalent of database column
     * av_project.date_updated
     */
