...
public class VwPhoto extends OrmBean {
    ...
    /**
     * The property name constant equivalent to property, ImageId, of respective
     * DataSource view.
     */
    public static final String PROP_IMAGEID = "ImageId";
    /**
     * The property name constant equivalent to property, DirPath, of respective
     * DataSource view.
     */
    ...
    /**
     * The property name constant equivalent to property, FileSize, of
     * respective DataSource view.
     */
    public static final String PROP_FILESIZE = "FileSize";
    /**
     * The property name constant equivalent to property, FileExt, of respective
     * DataSource view.
     */
    ...
    /**
     * The property name constant equivalent to property, MimeTypeFileExt, of
     * respective DataSource view.
     */
    public static final String PROP_MIMETYPEFILEEXT = "MimeTypeFileExt";
    /**
     * The property name constant equivalent to property, MediaType, of
     * respective DataSource view.
     */
