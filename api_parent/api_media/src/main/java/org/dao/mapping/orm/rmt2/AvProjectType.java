...
public boolean equals(Object obj) {
   ...
   final AvProjectType other = (AvProjectType) obj; 
...
@Override
public int hashCode() {
   return HashCodeAssistant.combineHashCodes(HashCodeAssistant.hashObject(this.projectTypeId),
               HashCodeAssistant.hashObject(this.description));
} 

@Override
public String toString() {
   return "AvProjectType [projectTypeId=" + projectTypeId + 
