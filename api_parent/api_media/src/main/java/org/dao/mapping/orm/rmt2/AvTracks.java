...
public class AvTracks extends OrmBean {
    ...
    /**
     * The property name constant equivalent to property, TrackId, of respective
     * DataSource view.
     */
    public static final String PROP_TRACKID = "TrackId";
    /**
     * The property name constant equivalent to property, ProjectId, of
     * respective DataSource view.
     */
    public static final String PROP_PROJECTID = "ProjectId";
    /**
     * The property name constant equivalent to property, TrackNumber, of
     * respective DataSource view.
     */
    public static final String PROP_TRACKNUMBER = "TrackNumber";
    /**
     * The property name constant equivalent to property, TrackTitle, of
     * respective DataSource view.
     */
    public static final String PROP_TRACKTITLE = "TrackTitle";
    /**
     * The property name constant equivalent to property, TrackHours, of
     * respective DataSource view.
     */
    public static final String PROP_TRACKHOURS = "TrackHours";
    /**
     * The property name constant equivalent to property, TrackMinutes, of
     * respective DataSource view.
     */
    public static final String PROP_TRACKMINUTES = "TrackMinutes";
    /**
     * The property name constant equivalent to property, TrackSeconds, of
     * respective DataSource view.
     */
    public static final String PROP_TRACKSECONDS = "TrackSeconds";
    /**
     * The property name constant equivalent to property, TrackDisc, of
     * respective DataSource view.
     */
    public static final String PROP_TRACKDISC = "TrackDisc";
    /**
     * The property name constant equivalent to property, TrackProducer, of
     * respective DataSource view.
     */
    public static final String PROP_TRACKPRODUCER = "TrackProducer";
    /**
     * The property name constant equivalent to property, TrackComposer, of
     * respective DataSource view.
     */
    public static final String PROP_TRACKCOMPOSER = "TrackComposer";
    /**
     * The property name constant equivalent to property, TrackLyricist, of
     * respective DataSource view.
     */
    public static final String PROP_TRACKLYRICIST = "TrackLyricist";
    /**
     * The property name constant equivalent to property, LocServername, of
     * respective DataSource view.
     */
    public static final String PROP_LOCSERVERNAME = "LocServername";
    /**
     * The property name constant equivalent to property, LocSharename, of
     * respective DataSource view.
     */
    public static final String PROP_LOCSHARENAME = "LocSharename";
    /**
     * The property name constant equivalent to property, LocRootPath, of
     * respective DataSource view.
     */
    public static final String PROP_LOCROOTPATH = "LocRootPath";
    /**
     * The property name constant equivalent to property, LocPath, of respective
     * DataSource view.
     */
    public static final String PROP_LOCPATH = "LocPath";
    /**
     * The property name constant equivalent to property, LocFilename, of
     * respective DataSource view.
     */
    public static final String PROP_LOCFILENAME = "LocFilename";
    /**
     * The property name constant equivalent to property, Comments, of
     * respective DataSource view.
     */
    ...
    /**
     * The property name constant equivalent to property, TrackArtist, of
     * respective DataSource view.
     */
    ...
    /**
     * The javabean property equivalent of database column
     * av_tracks.track_minutes
     */
    private int trackMinutes;
    /**
     * The javabean property equivalent of database column
     * av_tracks.track_seconds
     */
    ...
    /**
     * The javabean property equivalent of database column
     * av_tracks.track_producer
     */
    private String trackProducer;
    /**
     * The javabean property equivalent of database column
     * av_tracks.track_composer
     */
    private String trackComposer;
    /**
     * The javabean property equivalent of database column
     * av_tracks.track_lyricist
     */
    private String trackLyricist;
    /**
     * The javabean property equivalent of database column
     * av_tracks.loc_servername
     */
    private String locServername;
    /**
     * The javabean property equivalent of database column
     * av_tracks.loc_sharename
     */
    private String locSharename;
    /**
     * The javabean property equivalent of database column
     * av_tracks.loc_root_path
     */
    ...
    /**
     * The javabean property equivalent of database column
     * av_tracks.date_created
     */
    private java.util.Date dateCreated;
    /**
     * The javabean property equivalent of database column
     * av_tracks.date_updated
     */
