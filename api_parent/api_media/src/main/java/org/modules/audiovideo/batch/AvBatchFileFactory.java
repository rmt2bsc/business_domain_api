...
public class AvBatchFileFactory extends RMT2Base {
    ...
    /**
     * Creates an instance of the AvBatchFileProcessorApi using the batch file
     * meta data importer implementation.
     * 
     * @param parms
     ...
     */
    public static final AvBatchFileProcessorApi createMediaFileBatchImportApiInstance(AvBatchImportParameters parms)
            throws BatchFileProcessException {
        AvBatchFileProcessorApi api;
        api = new AvFileMetaDataLoaderApiImpl(parms);
        return api;
    }
