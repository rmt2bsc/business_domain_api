...
public class UserResourceAccess extends OrmBean {
    ...
    // UserResourceAccessView

    /**
     * The property name constant equivalent to property, RsrcAccessId, of
     ...
     * user_resource_access.rsrc_access_id
     */
    private int rsrcAccessId;
    /**
     * The javabean property equivalent of database column
     * user_resource_access.grp_id
     */
    private int grpId;
    /**
     * The javabean property equivalent of database column
     * user_resource_access.rsrc_id
     */
    private int rsrcId;
    /**
     * The javabean property equivalent of database column
     * user_resource_access.login_id
     */
    private int loginId;
    /**
     * The javabean property equivalent of database column
     * user_resource_access.date_updated
     */
    private java.util.Date dateUpdated;
    /**
     * The javabean property equivalent of database column
     * user_resource_access.date_created
     */
    private java.util.Date dateCreated;
    /**
     * The javabean property equivalent of database column
     * user_resource_access.user_id
     */
