...
public class UserResourceSubtype extends OrmBean {
     ...
     * user_resource_subtype.rsrc_subtype_id
     */
    private int rsrcSubtypeId;
    /**
     * The javabean property equivalent of database column
     * user_resource_subtype.rsrc_type_id
     */
    private int rsrcTypeId;
    /**
     * The javabean property equivalent of database column
     * user_resource_subtype.name
     */
    private String name;
    /**
     * The javabean property equivalent of database column
     * user_resource_subtype.description
     */
    private String description;
    /**
     * The javabean property equivalent of database column
     * user_resource_subtype.date_created
     */
    private java.util.Date dateCreated;
    /**
     * The javabean property equivalent of database column
     * user_resource_subtype.date_updated
     */
    private java.util.Date dateUpdated;
    /**
     * The javabean property equivalent of database column
     * user_resource_subtype.user_id
     */
