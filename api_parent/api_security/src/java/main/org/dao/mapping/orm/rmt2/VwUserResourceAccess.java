...
public class VwUserResourceAccess extends OrmBean {
    ...
    // VwUserResourceAccessView

    /**
     * The property name constant equivalent to property, RsrcId, of respective
     * DataSource view.
     */
    public static final String PROP_RSRCID = "RsrcId";
    /**
     * The property name constant equivalent to property, ResrcName, of
     * respective DataSource view.
     */
    public static final String PROP_RESRCNAME = "ResrcName";
    /**
     * The property name constant equivalent to property, ResrcUrl, of
     * respective DataSource view.
     */
    public static final String PROP_RESRCURL = "ResrcUrl";
    /**
     * The property name constant equivalent to property, ResrcDesc, of
     * respective DataSource view.
     */
    public static final String PROP_RESRCDESC = "ResrcDesc";
    /**
     * The property name constant equivalent to property, ResrcSecured, of
     * respective DataSource view.
     */
    public static final String PROP_RESRCSECURED = "ResrcSecured";
    /**
     * The property name constant equivalent to property, RsrcTypeId, of
     * respective DataSource view.
     */
    public static final String PROP_RSRCTYPEID = "RsrcTypeId";
    /**
     * The property name constant equivalent to property, ResrcTypeName, of
     * respective DataSource view.
     */
    public static final String PROP_RESRCTYPENAME = "ResrcTypeName";
    /**
     * The property name constant equivalent to property, RsrcSubtypeId, of
     * respective DataSource view.
     */
    public static final String PROP_RSRCSUBTYPEID = "RsrcSubtypeId";
    /**
     * The property name constant equivalent to property, Host, of respective
     * DataSource view.
     */
    public static final String PROP_HOST = "Host";
    /**
     * The property name constant equivalent to property, ResrcSubtypeName, of
     * respective DataSource view.
     */
    public static final String PROP_RESRCSUBTYPENAME = "ResrcSubtypeName";
    /**
     * The property name constant equivalent to property, ResrcSubtypeDesc, of
     * respective DataSource view.
     */
    public static final String PROP_RESRCSUBTYPEDESC = "ResrcSubtypeDesc";
    /**
     * The property name constant equivalent to property, UserUid, of respective
     * DataSource view.
     */
    public static final String PROP_USERUID = "UserUid";
    /**
     * The property name constant equivalent to property, Username, of
     * respective DataSource view.
     */
    public static final String PROP_USERNAME = "Username";
    /**
     * The property name constant equivalent to property, UserFirstname, of
     * respective DataSource view.
     */
    public static final String PROP_USERFIRSTNAME = "UserFirstname";
    /**
     * The property name constant equivalent to property, UserLastname, of
     * respective DataSource view.
     */
    public static final String PROP_USERLASTNAME = "UserLastname";
    /**
     * The property name constant equivalent to property, UserActiveStatus, of
     * respective DataSource view.
     */
    public static final String PROP_USERACTIVESTATUS = "UserActiveStatus";
    /**
     * The property name constant equivalent to property, UserEmail, of
     * respective DataSource view.
     */
    public static final String PROP_USEREMAIL = "UserEmail";
    /**
     * The property name constant equivalent to property, UserGroupId, of
     * respective DataSource view.
     */
    public static final String PROP_USERGROUPID = "UserGroupId";
    /**
     * The property name constant equivalent to property, UserGroupName, of
     * respective DataSource view.
     */
     ...
     * vw_user_resource_access.rsrc_id
     */
    private int rsrcId;
    /**
     * The javabean property equivalent of database column
     * vw_user_resource_access.resrc_name
     */
    private String resrcName;
    /**
     * The javabean property equivalent of database column
     * vw_user_resource_access.resrc_url
     */
    private String resrcUrl;
    /**
     * The javabean property equivalent of database column
     * vw_user_resource_access.resrc_desc
     */
    private String resrcDesc;
    /**
     * The javabean property equivalent of database column
     * vw_user_resource_access.resrc_secured
     */
    private int resrcSecured;
    /**
     * The javabean property equivalent of database column
     * vw_user_resource_access.rsrc_type_id
     */
    private int rsrcTypeId;
    /**
     * The javabean property equivalent of database column
     * vw_user_resource_access.resrc_type_name
     */
    private String resrcTypeName;
    /**
     * The javabean property equivalent of database column
     * vw_user_resource_access.rsrc_subtype_id
     */
    private int rsrcSubtypeId;
    /**
     * The javabean property equivalent of database column
     * vw_user_resource_access.host
     */
    private String host;
    /**
     * The javabean property equivalent of database column
     * vw_user_resource_access.resrc_subtype_name
     */
    private String resrcSubtypeName;
    /**
     * The javabean property equivalent of database column
     * vw_user_resource_access.resrc_subtype_desc
     */
    private String resrcSubtypeDesc;
    /**
     * The javabean property equivalent of database column
     * vw_user_resource_access.user_uid
     */
    private int userUid;
    /**
     * The javabean property equivalent of database column
     * vw_user_resource_access.username
     */
    private String username;
    /**
     * The javabean property equivalent of database column
     * vw_user_resource_access.user_firstname
     */
    private String userFirstname;
    /**
     * The javabean property equivalent of database column
     * vw_user_resource_access.user_lastname
     */
    private String userLastname;
    /**
     * The javabean property equivalent of database column
     * vw_user_resource_access.user_active_status
     */
    private int userActiveStatus;
    /**
     * The javabean property equivalent of database column
     * vw_user_resource_access.user_email
     */
    private String userEmail;
    /**
     * The javabean property equivalent of database column
     * vw_user_resource_access.user_group_id
     */
    private int userGroupId;
    /**
     * The javabean property equivalent of database column
     * vw_user_resource_access.user_group_name
     */
