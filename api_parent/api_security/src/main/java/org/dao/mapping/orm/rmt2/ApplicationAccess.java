...
public class ApplicationAccess extends OrmBean {
    ...
    /**
     * The property name constant equivalent to property, AppAccessId, of
     * respective DataSource view.
     */
    public static final String PROP_APPACCESSID = "AppAccessId";
    /**
     * The property name constant equivalent to property, AppId, of respective
     * DataSource view.
     */
    ...
    /**
     * The property name constant equivalent to property, Loggedin, of
     * respective DataSource view.
     */
    public static final String PROP_LOGGEDIN = "Loggedin";
    /**
     * The property name constant equivalent to property, LoginDate, of
     * respective DataSource view.
     */
    public static final String PROP_LOGINDATE = "LoginDate";
    /**
     * The property name constant equivalent to property, LastLoginDate, of
     * respective DataSource view.
     */
    public static final String PROP_LASTLOGINDATE = "LastLoginDate";
    /**
     * The property name constant equivalent to property, SessionId, of
     * respective DataSource view.
     */
     ...
     * application_access.app_access_id
     */
    private int appAccessId;
    /**
     * The javabean property equivalent of database column
     * application_access.app_id
     */
    private int appId;
    /**
     * The javabean property equivalent of database column
     * application_access.login_id
     */
    private int loginId;
    /**
     * The javabean property equivalent of database column
     * application_access.loggedin
     */
    private int loggedin;
    /**
     * The javabean property equivalent of database column
     * application_access.login_date
     */
    private java.util.Date loginDate;
    /**
     * The javabean property equivalent of database column
     * application_access.last_login_date
     */
    private java.util.Date lastLoginDate;
    /**
     * The javabean property equivalent of database column
     * application_access.session_id
     */
