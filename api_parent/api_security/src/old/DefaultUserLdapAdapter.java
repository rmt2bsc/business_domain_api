...
/**
 * An adapter for user related objects.
 * <p>
 * 
 * @author rterrell
 *
 */
class DefaultUserLdapAdapter extends TransactionDtoImpl implements User, UserDto {
     ...
     */
    protected DefaultUserLdapAdapter() {
	super();
    }
    ...
    /**
     * @param queryLoggedInFlag the queryLoggedInFlag to set
     */
