...
/**
 * Test VwUser adapter as it pertains to the Security API module.
 * 
 * @author roy.terrell
 *
 */
public class VwUserAdapterTest {
    ...
    public void testUserLoginOrm() {
        VwUser o1 = SecurityMockDataFactory.createOrmVwUser(SecurityMockDataFactory.TEST_USER_ID, 
                SecurityMockDataFactory.TEST_GROUP_ID, "user_name", "test1234", "2018-01-01", "short_name");
        ...
        try {
            String hashPw = CryptoUtils.byteArrayToHexString(CryptoUtils.computeHash(dto.getUsername() + "test1234"));
            Assert.assertEquals(hashPw, dto.getPassword());
